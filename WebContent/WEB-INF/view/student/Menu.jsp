...
<body>
                                <li class="nav-item">
                                    <div class="nav-link text-white p-1 mb-2 sidebar-link" style="background-color:#CC0000; color:white; border-radius: 4px;">
                                ...
                                <li class="nav-item">
                                    <a href="<%=request.getContextPath()%>/loadIdentity.html" class="nav-link text-white p-3 mb-2 sidebar-link" style="background-color:#4285F4; color:white; border-radius: 4px;">
                                        <i class="fas fa-user-tie text-light fa-lg mr-3"></i>UPDATE IDENTITY</a>
                                </li>
                                <li class="nav-item">
                                    <a href="<%=request.getContextPath() %>/feesdisplay.html" class="nav-link text-white p-3 mb-2 sidebar-link" style="background-color:#ffbb33; color:white; border-radius: 4px;">
                                ...
                                <li class="nav-item">
                                    <a href="<%=request.getContextPath() %>/studentres.html" class="nav-link text-white p-3 mb-2 sidebar-link" style="background-color:#e91e63; color:white; border-radius: 4px;">
                                ...
                                <li class="nav-item">
                                    <a href="<%=request.getContextPath() %>/infodisplay.html" class="nav-link text-white p-3 mb-2 sidebar-link" style="background-color:#b2ff59; color:white; border-radius: 4px;">
                                        <i class="fas fa-user text-light fa-lg mr-3"></i>STUDENT INFORMATION</a>
                                </li>
                                <li class="nav-item">
                                    <a href="<%=request.getContextPath()%>/editRegister.html" class="nav-link text-white p-3 mb-2 sidebar-link" style="background-color:#CC0000; color:white; border-radius: 4px;">
                                        <i class="fas fa-wrench text-light fa-lg mr-3"></i>SETTING</a>
                                </li>
                                <li class="nav-item">
